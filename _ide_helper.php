 ...
 * Generated for Laravel 5.7.9 on 2018-10-21 08:25:57.
 *
...
namespace LaraSupport\Facades { 
    ...
    class LaraDB {
        ...
        public static function hasTable($table)
        {
            return \LaraSupport\LaraDB::hasTable($table);
        }
        ...
        public static function hasColumn($table, $column)
        {
            return \LaraSupport\LaraDB::hasColumn($table, $column);
        }
        ...
        {
            return \LaraSupport\LaraDB::getFullColumns($columns, $table, $prefix);
        }
        ...
        {
            return \LaraSupport\LaraDB::getTables();
        }
        ...
        {
            return \LaraSupport\LaraDB::getColumnsFullInfo($table);
        }
        ...
        {
            return \LaraSupport\LaraDB::getDBStructure();
        }
    ...
    class LaraPassword {
        ...
        {
            return \LaraSupport\LaraPassword::hashPassword($password);
        }
        ...
        {
            return \LaraSupport\LaraPassword::verifyPassword($password, $passwordHash);
        }
...
namespace  { 
    ...
    class LaraDB extends \LaraSupport\Facades\LaraDB {}

    class LaraPassword extends \LaraSupport\Facades\LaraPassword {}
